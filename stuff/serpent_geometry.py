...
def vertical_stack(z_values, universes, x0=0.0, y0=0.0, universe_id=None):
    ...
    # Serpent type 9 typically omits the region below the first z plane,
    # but allow either convention based on the number of universes provided.
    ...
    for cell, univ in zip(fill_cells, universes):
        cell.fill = univ
